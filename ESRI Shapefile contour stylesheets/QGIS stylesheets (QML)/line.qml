...
<qgis version="2.8.1-Wien" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="PROP_VALUE">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="SUB_TYPE" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="master" label="master"/>
      <category render="true" symbol="1" value="meanHighWater" label="meanHighWater"/>
      <category render="true" symbol="2" value="meanLowWater" label="meanLowWater"/>
      <category render="true" symbol="3" value="ordinary" label="ordinary"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="224,148,94,255"/>
    ...
    <source-symbol>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="125,245,104,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.26"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN ( &quot;PROP_VALUE&quot;  LIKE '%00' OR  &quot;PROP_VALUE&quot;  LIKE '%50') THEN  &quot;PROP_VALUE&quot;  END"/>
    ...
    <property key="labeling/repeatDistance" value="300"/>
