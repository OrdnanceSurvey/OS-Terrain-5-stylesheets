...
<qgis version="2.12.0-Lyon" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="contourLineType">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="contourLineType" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="master" label="master"/>
      <category render="true" symbol="1" value="ordinary" label="ordinary"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN  (  &quot;contourLineType&quot; =  'master' ) THEN   &quot;propertyValue&quot;  END"/>
