...
<qgis version="2.12.0-Lyon" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="waterLevelCategory">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 attr="waterLevelCategory" forceraster="0" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="meanHighWater" label="meanHighWater"/>
      <category render="true" symbol="1" value="meanLowWater" label="meanLowWater"/>
    </categories>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN ( &quot;waterLevelCategory&quot;  =  'meanHighWater' ) THEN  &quot;propertyValue&quot; END"/>
    ...
    <property key="labeling/textColorB" value="229"/>
    <property key="labeling/textColorG" value="154"/>
    <property key="labeling/textColorR" value="23"/>
