...
<qgis version="2.2.0-Valmiera" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="waterLevelCategory" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="meanHighWater" label="meanHighWater"/>
      <category symbol="1" value="meanLowWater" label="meanLowWater"/>
    </categories>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="color" v="23,154,229,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/fieldName" value="CASE WHEN  &quot;FEAT_TYPE&quot;  =  'ContourLine'  THEN  &quot;PROP_VALUE&quot;  END"/>
    ...
    <property key="labeling/textColorB" value="94"/>
    <property key="labeling/textColorG" value="148"/>
    <property key="labeling/textColorR" value="224"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="PROP_VALUE"/>
    <edittype labelontop="0" editable="1" type="0" name="SUB_TYPE"/>
    <edittype labelontop="0" editable="1" type="0" name="gml_id"/>
    <edittype labelontop="0" editable="1" type="0" name="propertyValue"/>
    <edittype labelontop="0" editable="1" type="0" name="propertyValue_uom"/>
    <edittype labelontop="0" editable="1" type="0" name="waterLevelCategory"/>
  </edittypes>
  <editform></editform>
